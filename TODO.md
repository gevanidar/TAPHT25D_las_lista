...
- https://tap-ht25-testverktyg.github.io/exam/ 
...
- [ ] Use `https://github.com/tap-ht25-testverktyg/08_playwright_bdd` for reference on structure
...
- [ ] Read the [assignment.md](./assignment.md) file to ensure that everything is covered.
- [ ] Read the [assignment.md](./assignment.md) file if anything is uncertain.
