...
def step_impl(context):
    """Step for adding an empty title to the add new book title input."""
...
def step_impl(context):
    """Step for adding an empty author to the add new book author input."""
...
def step_impl(context, title):
    """Step for adding a title to the add new book title input."""
...
def step_impl(context, author):
    """Step for adding a author to the add new book author input."""
...
def step_impl(context, title2, author2):
    """Step for validating that the list contains the book and that it is last in the list."""
